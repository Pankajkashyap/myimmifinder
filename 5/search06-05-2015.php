		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col">Internet (6 Mbps, Unlimited Data, Cable/ADSL)</th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Fitness Club, Monthly Fee for 1 Adult </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Tennis Court Rent (1 Hour on Weekend) </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Cinema, International Release, 1 Seat </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Apartment (1 bedroom) in City Centre </th>
						<th scope="col"> Apartment (1 bedroom) Outside of Centre </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Clothing male </th>
						<th scope="col"> clothing women/girls </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> Pack of Cigarettes (Marlboro) </th>
					</tr>
				</thead>
				<tbody>
		...
		/* $(function(){
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col"> One-way Ticket (Local Transport) </th>
					</tr>
				</thead>
				<tbody>
						...
						<?php
							$getTransportations = $conn->getTransportation($_GET['source']);
							foreach($getTransportations as $getTransportation){
						?>
						<tr class="sss">
							<td><strong><?php echo @$getTransportation->statename ; ?></strong></td>
							<td>$<?php echo @$getTransportation->name ; ?></td>
						</tr>
						<?php } ?>
						...
						<?php
							$getTransportations = $conn->getTransportation($_GET['destination']);
							foreach($getTransportations as $getTransportation){
						?>
						<tr class="sss">
							<td><strong><?php echo @$getTransportation->statename ; ?></strong></td>
