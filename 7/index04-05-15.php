		...
		<div class="row">
			<form class="form-signin" action="search.php">
				...
				<div class="col-xs-12 col-md-12">
					...
					<button class="btn btn-primary btn-block submit" type="submit" value="all" name="action">Attire</button>
					<button class="btn btn-primary btn-block submit" type="submit" value="all" name="action">Saftey and Security</button>
					<button class="btn btn-primary btn-block submit" type="submit" value="all" name="action">Transportation</button>
