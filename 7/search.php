		...
		$(function(){
			$("#statesource").change(function(){
				...
				$.ajax({
					...
					method:"POST",
					dataType:"json",
					data:{sourceid:sourcestate, action:"source", t:'transportation', classarray:arr},
					success: function(res){
						if(res.status  == true){
							$(".sss").css("display", "none");
							$("#mytable").find("tbody .ss").html(res.food);
			...
			$("#statedestination").change(function(){
				...
				$.ajax({
					...
					method:"POST",
					dataType:"json",
					data:{sourceid:sourcedest, action:'destination', t:'transportation', classarray:arr},
					success: function(res){
						if(res.status  == true){
							$(".ddd").css("display", "none");
							$("#mytable").find("tbody .dd").html(res.food);
			...
			<table class="tablesaw table table-hover" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-minimap id="mytable">
				<thead>
					<tr>
						<th scope="col" data-tablesaw-priority="persist">State</th>
						<th scope="col" class=""> One-way Ticket (Local Transport) </th>
					</tr>
				</thead>
				<tbody>
						...
						<?php
							...
							$getTransportations = array_slice($getTransportations, 0, 1);
