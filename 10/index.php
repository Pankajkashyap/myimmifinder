		...
		<div class="row">
			<form class="form-signin" action="search.php">
				...
				<div class="col-xs-12 col-md-12">
					...
					<button class="btn btn-primary btn-block submit" type="submit" value="tobacco" name="action">Tobacco</button>
					<button class="btn btn-primary btn-block submit" type="submit" value="hospital" name="action">Hospital</button>
				</div>
			</form>
		</div>
    </div>
